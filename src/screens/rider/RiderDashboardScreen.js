...
export default function RiderDashboardScreen({ navigation }) {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top, backgroundColor: colors.background }]}>
      ...
      <View style={[styles.backgroundCanvas, { backgroundColor: colors.background }]} pointerEvents="none">
        <View style={[styles.backgroundOrb, styles.backgroundOrbTop, isDarkMode && { opacity: 0.3 }]} />
        <View style={[styles.backgroundOrb, styles.backgroundOrbMid, isDarkMode && { opacity: 0.3 }]} />
        <View style={[styles.backgroundOrb, styles.backgroundOrbBottom, isDarkMode && { opacity: 0.3 }]} />
      </View>
