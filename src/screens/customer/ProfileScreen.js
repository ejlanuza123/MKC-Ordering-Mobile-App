      ...
      <View style={[styles.container, { paddingTop: insets.top, backgroundColor: colors.background }]}>
        ...
        >
            ...
            <View style={[styles.preferenceItem, { borderBottomColor: 'transparent' }]}>
              <View style={styles.preferenceInfo}>
                <Animated.View style={{ transform: [{ rotate: spin }, { scale }] }}>
                  <Ionicons name={isDarkMode ? "moon" : "sunny"} size={22} color={isDarkMode ? "#60A5FA" : (colors.primary || "#F59E0B")} />
                </Animated.View>
                <View style={styles.preferenceText}>
          ...
          <View style={styles.appInfo}>
            <Text style={[styles.appVersion, { color: colors.textMuted }]}>MKC Foods App v2.25.6</Text>
            <Text style={[styles.appCopyright, { color: colors.textMuted }]}>© 2026 MKC Foods Corporation</Text>
          </View>
        </ScrollView>
